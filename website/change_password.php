        ...
        <div class="my-profile__container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="settings-block">
                        <ul class="settings">
                            <li class="setting setting--current"><a href="change_password.html" class="setting__link"><i class="ion-ios-unlocked-outline setting__icon"></i>Change Password</a></li>
                            <li class="setting"><a href="index-2.html" class="setting__link"><i class="ion-ios-undo-outline setting__icon"></i>Log Out</a></li>
                        </ul><!-- settings -->
                    </div><!-- .settings-block -->
                </div><!-- .col -->
                <form action="http://boostifythemes.com/demo/html/realand/change_password.html">
                    <div class="col-md-9">
                        <label for="profile-current-password" class="my-profile__label">Current Password</label>
                        <input type="text" class="my-profile__field" id="profile-current-password">

                        <label for="profile-new-password" class="my-profile__label">New Password</label>
                        <input type="text" class="my-profile__field" id="profile-new-password">

                        <label for="profile-confirm-password" class="my-profile__label">Confirm New Password</label>
                        <input type="text" class="my-profile__field" id="profile-confirm-password">
...
<!-- Mirrored from boostifythemes.com/demo/html/realand/change_password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2020 12:13:37 GMT -->
</html>