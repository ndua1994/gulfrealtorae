...
<head>
	...
	<title>ReaLand</title>
	<meta charset="UTF-8">
	<meta name="description" content="Gulf Realtor Real Estate Company">
...
<?php include 'common/header.php';?>
   <section>
          <div class="pxp-hero vh-100">
                <div class="pxp-hero-bg pxp-cover pxp-cover-bottom" style="background-image: url(images/hero-img-1.jpg);"></div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control pxp-is-address" placeholder="Project name, Developer, Community...">
                                        <span class="fa fa-search"></span>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12">
                                   <img src="images/get-a-call-img.png"> 
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="featured-listing__slider">
      <div class="row">
        <div class="col-sm-6 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/aseel-villas.jpg" href="emaar-aseel-villas.php" alt="Aseel Villa by Emaar" class="listing__img">
            <ul class="listing__stats listing__stats--absolute listing__stats--secondary">
              <li><span class="listing__figure">4 - 7</span> Beds</li>
              <li><span class="listing__figure">3 - 6</span> Baths</li>
              <li><span class="listing__figure">5,395</span> Sq.ft</li>
            </ul>
            ...
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
                <div class="listing__header-primary">
                  <h3 class="listing__title listing__title--white"><a href="emaar-aseel-villas.php">Aseel Villa</a></h3>
                ...
                <p class="listing__price listing__price--no-b-margin"><a href="emaar-aseel-villas.php">AED 8,574,888</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/expo-golf-v.jpg" alt="Emaar Expo Golf Villas – Phase V" class="listing__img">
            <ul class="listing__stats listing__stats--absolute listing__stats--secondary">
              <li><span class="listing__figure">3 & 4</span> Beds</li>
              <li><span class="listing__figure">3 & 4</span> Baths</li>
              <li><span class="listing__figure">654</span> Sq.ft</li>
            </ul>
            <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
      ...
      <div class="row">
        <div class="col-sm-6 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/il-primo.jpg" alt="IL Primo at Downtown Dubai" class="listing__img">
            <ul class="listing__stats listing__stats--absolute listing__stats--secondary">
              <li><span class="listing__figure">4 - 6<sup>&plus;</sup></span> Beds</li>
              <li><span class="listing__figure">5,253</span> sq.ft</li>
            </ul>
            <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
                <div class="listing__header-primary">
                  <h3 class="listing__title listing__title--white"><a href="#">IL Primo Apartment and Duplex</a></h3>
        ...
        <div class="col-sm-6 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/forte.jpg" alt="Forte Apartment by Emaar" class="listing__img">
            <ul class="listing__stats listing__stats--absolute listing__stats--secondary">
              <li><span class="listing__figure">1 - 4<sup>&plus;</sup></span> Beds</li>
              <li><span class="listing__figure">846</span> sq.ft</li>
            </ul>
            <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
                <div class="listing__header-primary">
                  <h3 class="listing__title listing__title--white"><a href="#">Forte Apartment by Emaar</a></h3>
                  <p class="listing__location listing__location--no-b-margin"><span class="ion-ios-location-outline listing__location-icon"></span> Downtown Dubai, UAE</p>
                </div>
                <p class="listing__price listing__price--no-b-margin">AED 1,949,888</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-6 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/burj-crown.jpg" alt="Emaar Burj Crown Apartments" class="listing__img">
            <ul class="listing__stats listing__stats--absolute listing__stats--secondary">
              <li><span class="listing__figure">1 - 3<sup>&plus;</sup></span> Beds</li>
              <li><span class="listing__figure">987</span> Sq.ft</li>
            </ul>
            <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
                <div class="listing__header-primary">
                  <h3 class="listing__title listing__title--white"><a href="#">Burj Crown Apartments</a></h3>
                  <p class="listing__location listing__location--no-b-margin"><span class="ion-ios-location-outline listing__location-icon"></span> Downtown Dubai, UAE</p>
                </div>
                <p class="listing__price listing__price--no-b-margin">AED 1,780,888</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/act1-act2.jpg" alt="Emaar Act One Act Two" class="listing__img">
            <ul class="listing__stats listing__stats--absolute listing__stats--secondary">
              <li><span class="listing__figure">1 - 4<sup>&plus;</sup></span> Beds</li>
              <li><span class="listing__figure">607</span> sq.ft</li>
            </ul>
            <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
                <div class="listing__header-primary">
                  <h3 class="listing__title listing__title--white"><a href="#">Act One | Act Two</a></h3>
                  <p class="listing__location listing__location--no-b-margin"><span class="ion-ios-location-outline listing__location-icon"></span> Downtown Dubai, UAE</p>
                </div>
                <p class="listing__price listing__price--no-b-margin">AED 1,480,888</p>
              </div>
            </div>
          </div>
        </div>
...
<section class="item-grid">
  <div class="container">
    ...
    <div class="item-grid--centered">
      <a href="sale-properties.php" class="item-grid__load-more">Load More</a>
    </div>
  </div>
</section>
      ...
      <div class="row">
        <div class="col-md-3 vitual-main-div">
          <div class="upper-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-img/high-gardens-thumb.jpg"></a>
          </div>
          <div class="lower-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-w.png" class="vir-t"></a>
          </div>
          <a href="emaar-aseel-villas.php"><h5 class="vtp-name">High Gardens</h5></a>
        </div>
        <div class="col-md-3 vitual-main-div">
          <div class="upper-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-img/bellavista-thumb.jpg"></a>
          </div>
          <div class="lower-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-w.png" class="vir-t"></a>
          </div>
        ...
        <div class="col-md-3 vitual-main-div">
          <div class="upper-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-img/loreto-thumb.jpg"></a>
          </div>
          <div class="lower-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-w.png" class="vir-t"></a>
          </div>
        ...
        <div class="col-md-3 vitual-main-div">
          <div class="upper-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-img/radisson-thumb.jpg"></a>
          </div>
          <div class="lower-image-div">
            <a href="emaar-aseel-villas.php"><img src="images/virtual-tour-w.png" class="vir-t"></a>
          </div>
...
<?php /*<section class="features">
  <div class="features__overlay">
    <div class="container">
       <h3 class="award-header">Awards & Achievements</h3>
      <div class="row">
        <div class="col-sm-3">
          <div class="feature">
            <img src="images/awards/Emaar-Annual-Broker-award-2019.png" alt="Map" class="feature__icon">
            <h3 class="feature__title">Emaar Annual Broker Awards 2019</h3>&nbsp;
          </div>
        </div>

        <div class="col-sm-3">
          <div class="feature">
            <img src="images/awards/top-per-agency.png" alt="Search" class="feature__icon">
            <h3 class="feature__title">Meraas Top Performing Agency of the year 2019</h3>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="feature">
            <img src="images/awards/top-per-agency-3.png" alt="Negotiation" class="feature__icon">
            <h3 class="feature__title">Meraas Top Performing Agency for Q.1 – 2019</h3>
          </div>
...
<section class="new-listing--b-border">
  <!--<div class="container">
    <div class="new-listing__inner">
      <div class="new-listing__header">
        <h2 class="section__title section__title--b-margin">New Listing By Region</h2>
      ...
      <div class="new-listing__container">
        <div class="new-listing--col-md-6">
          <div class="new-listing__block">
            <a href="#">
              <div class="new-listing__bg new-listing__bg--ohio-1 new-listing--wide"></div>

              <div class="new-listing__content">  
                <h3 class="new-listing__title">Downtown Dubai</h3>
          ...
          <div class="new-listing__parent">
            <div class="row">
              <div class="col-md-6">
                <div class="new-listing__block">
                  <a href="#">
                    <div class="new-listing__bg new-listing__bg--new-jersey-1 new-listing--small"></div>

                    <div class="new-listing__content">  
                      <h3 class="new-listing__title">Dubai Hills Estate</h3>
                      <p class="new-listing__desc">10 Listings</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="new-listing__block">
                  <a href="#">
                    <div class="new-listing__bg new-listing__bg--san-diego-1 new-listing--small"></div>

                    <div class="new-listing__content">  
                      <h3 class="new-listing__title">Arabian Ranches</h3>
                      <p class="new-listing__desc">4 Listings</p>
                    </div>
                  </a>
                </div>
              </div>
        ...
        <div class="new-listing--col-md-6">
          <div class="new-listing__block">
            <a href="#">
              <div class="new-listing__bg new-listing__bg--new-york-1 new-listing--large"></div>

              <div class="new-listing__content">  
                <h3 class="new-listing__title">Emaar South</h3>
                <p class="new-listing__desc">3 Listings</p>
              </div>
            </a>
          </div>
        </div>
  ...
  <!--<div class="item-grid--centered">
      <a href="community.php" class="item-grid__load-more">Load More</a>
    </div>
...
<div class="categories">
                            ...
                            <div class="category_bg_box cat-1-bg">
                                <div class="category-overlay">
                                    <div class="category-content">
                                         <div class="category-subtitle">1 Properties</div>
                                        <h3 class="category-title">
                                            <a href="#">DAMAC Hills</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-3-bg">
                                <div class="category-overlay">
                                    <div class="category-content">
                                         <div class="category-subtitle">1 Properties</div>
                                         <h3 class="category-title"><a href="#">Emaar South</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="category">
                    <div class="category_bg_box category_long_bg cat-4-bg">
                        <div class="category-overlay">
                            <div class="category-content">
                                <div class="category-subtitle">1 Properties</div>
                                <h3 class="category-title"><a href="downtown-dubai.html">Downtown Dubai</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="item-grid--centered">
      <a href="community.php" class="item-grid__load-more">View All Communities</a>
    </div>
  </div>
</div>
</section>
    ...
    <p class="vir-p">Looking for immediate possession - Here are some of newly built properties that are ready for occupation</p>
      ...
      <div class="row">
        <div class="col-sm-4 item-grid__container">
          <div class="listing">
            <img src="images/featured-img/aseel-villas.jpg" alt="Aseel Villa by Emaar" class="listing__img">
            <span class="listing__favorite"><img src="images/emaar.png"></span>
            <div class="listing__content listing__content--absolute listing__content--bg listing__content--less-b-padding">
              <div class="listing__header listing__header--no-b-margin">
                <div class="listing__header-primary">
  ...
  <h3 class="vir-header">Projects Special Offers</h3>
    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6 col-xs-12">
        <div class="famous-offers__single">
          <div class="famous-offers__header">
            <img src="images/project-offers-img/district1-diwali-offers.jpg" alt="district1 diwali offers">
            <ul class="famous-offers__social">
              <button class="offer-btn">Read More</button>
            </ul>
          </div>
      ...
      <div class="col-lg-3 col-sm-6 col-xs-12">
        <div class="famous-offers__single">
          <div class="famous-offers__header">
            <img src="images/project-offers-img/una-apertment-offres.jpg" alt="Nshama una apertment offres">
            <ul class="famous-offers__social">
              <button class="offer-btn">Read More</button>
            </ul>
          </div>
      ...
      <div class="col-lg-3 col-sm-6 col-xs-12">
        <div class="famous-offers__single">
          <div class="famous-offers__header">
            <img src="images/project-offers-img/ADDRESS_DUBAI_OPERA.jpg" alt="Address Dubai Opera Offers">
            <ul class="famous-offers__social">
              <button class="offer-btn">Read More</button>
            </ul>
          </div>
      ...
      <div class="col-lg-3 col-sm-6 col-xs-12">
        <div class="famous-offers__single">
          <div class="famous-offers__header">
            <img src="images/project-offers-img/mudon-view-dp-offers.jpg" alt="mudon views by Dubai Properties offers">
            <ul class="famous-offers__social">
             <button class="offer-btn">Read More</button>
            </ul>
          </div>
   ...
   <div class="item-grid--centered">
      <a href="special-offers.php" class="item-grid__load-more">Explore More Offers</a>
    </div>
</section>
<div class="clearfix"></div>
<!--<section>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="home-new-area">
        <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Al Hebiah Fourth, Dubai</h2>
        <a href="" class="pro-location">22 Projects</a>
        </div>
      </div>
       <div class="col-md-3">
        <div class="home-new-area">
         <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Al Barsha South Fourth,Dubai</h2>
        <a href="" class="pro-location">64 Projects</a>
        </div>
      </div> 
      <div class="col-md-3">
        <div class="home-new-area">
        <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Madinat Al Mataar, Dubai</h2>
        <a href="" class="pro-location">22 Projects</a>
        </div>
      </div> 
      <div class="col-md-3">
        <div class="home-new-area">
        <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Marsa Dubai, Dubai</h2>
        <a href="" class="pro-location">25 Projects</a>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3">
        <div class="home-new-area">
        <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Hadaeq Sheikh Mohammed Bin..</h2>
        <a href="" class="pro-location">25 Projects</a>
        </div>
      </div>
       <div class="col-md-3">
        <div class="home-new-area">
         <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Al Khairan First,Dubai</h2>
        <a href="" class="pro-location">28 Projects</a>
        </div>
      </div> 
      <div class="col-md-3">
        <div class="home-new-area">
        <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Al Merkadh, Dubai</h2>
        <a href="" class="pro-location">28 Projects</a>
        </div>
      </div> 
      <div class="col-md-3">
        <div class="home-new-area">
        <a href="" class="pro-location">Location</a>
        <h2 class="txt-l">Business Bay,Dubai</h2>
        <a href="" class="pro-location">54 Projects</a>
        </div>
      </div>
    </div>
    <div class="item-grid--centered">
      <a href="locations.php" class="item-grid__load-more">Explore New Location</a>
    </div>
  </div>
  </div>
</section>-->
<?php include 'common/footer.php';?>
<?php include 'common/footer_link_index.php';?>
</body>
