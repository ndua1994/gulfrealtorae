...
<h3 class="card-label">Edit Virtual Tour</h3>
</div>
<div class="card-toolbar">
<!--begin::Button-->
<a href="<?=base_url('virtual-tour/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('virtual-tour/update/'.$view_vt->vt_id.'')?>
<div class="card-body">

<div class="form-group">
<label>Image
<span class="text-danger">*</span></label>
<?php echo form_upload(['name'=>'vt_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$view_vt->vt_img.'')?>" width='80'>	
</div>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'vt_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>$view_vt->vt_img_alt];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'vt_heading','class'=>'form-control','placeholder'=>'Heading','value'=>$view_vt->vt_heading];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">URL
</label>
<?php
$data=['name'=>'vt_url','class'=>'form-control','placeholder'=>'URL','value'=>$view_vt->vt_url];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'vt_slug','class'=>'form-control','placeholder'=>'URL','value'=>$view_vt->vt_slug];
echo form_input($data);
?>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($view_vt->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('vt_img_hidden',$view_vt->vt_img)?>	
<button type="submit" name="edit_virtual_tour" class="btn btn-primary mr-2">Update</button>
