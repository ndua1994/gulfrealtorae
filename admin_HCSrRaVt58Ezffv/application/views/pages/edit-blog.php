...
<!--begin::Button-->
<a href="<?=base_url('blog/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('blog/update/'.$edit_blog->blog_id.'')?>
<div class="card-body">

<div class="form-group">
<label>Blog Image
<span class="text-danger">*</span></label>
<?php echo form_upload(['name'=>'blog_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$edit_blog->blog_img.'')?>" width='80'>	
</div>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Image Alt Tag
</label>
<?php
$data=['name'=>'blog_img_alt_tag','class'=>'form-control','placeholder'=>'Blog Image Alt Tag','value'=>$edit_blog->blog_img_alt_tag];
echo form_input($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Heading
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'blog_heading','class'=>'form-control','placeholder'=>'Blog Heading','value'=>$edit_blog->blog_heading];
echo form_input($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Short Description
</label>
<?php
$data=['name'=>'blog_short_description','class'=>'form-control','placeholder'=>'Blog Short Description','value'=>$edit_blog->blog_short_description];
echo form_textarea($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Blog Long Description
</label>
<textarea id="kt-tinymce-4" name="blog_long_description" class="tox-target" placeholder="Blog Long Description"><?=$edit_blog->blog_long_description?></textarea>
</div>

<div class="form-group">
<label>Blog Author Image</label>
<?php echo form_upload(['name'=>'blog_author_img','class'=>'form-control']);?>
<?php if(!empty($edit_blog->blog_author_img)){?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$edit_blog->blog_author_img.'')?>" width='80'>	
</div>
<?php }?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Author Image Alt Tag
</label>
<?php
$data=['name'=>'blog_author_img_alt','class'=>'form-control','placeholder'=>'Blog Author Image Alt Tag','value'=>$edit_blog->blog_author_img_alt];
echo form_input($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Author Name
</label>
<?php
$data=['name'=>'blog_author_name','class'=>'form-control','placeholder'=>'Blog Author Name','value'=>$edit_blog->blog_author_name];
echo form_input($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Author Description
</label>
<?php
$data=['name'=>'blog_author_descp','class'=>'form-control','placeholder'=>'Blog Author Description','value'=>$edit_blog->blog_author_descp];
echo form_textarea($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Tags
</label>
<input id="kt_tagify_1" class="form-control tagify" name='blog_tags' placeholder="Add Blog Tags" value=<?=$edit_blog->blog_tags?>>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Meta Title
</label>
<?php
$data=['name'=>'blog_meta_title','class'=>'form-control','placeholder'=>'Meta Title','value'=>$edit_blog->meta_title];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_meta_keyword','class'=>'form-control','placeholder'=>'Meta Keyword','value'=>$edit_blog->meta_keyword];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_meta_description','class'=>'form-control','placeholder'=>'Meta Description','value'=>$edit_blog->meta_description];
echo form_textarea($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Blog Slug
</label>
<?php
$data=['name'=>'blog_slug','class'=>'form-control','placeholder'=>'Blog Slug','value'=>$edit_blog->blog_slug];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($edit_blog->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('blog_img_hidden',$edit_blog->blog_img)?>
<?=form_hidden('blog_author_img_hidden',$edit_blog->blog_author_img)?>	
