...
<h3 class="card-label">Footer Section</h3>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('pages/footer_update')?>
<div class="card-body">
<div class="form-group">
<label>Image 
</label>
<input type="file" name="footer_logo_img" class="form-control">
</div>
<?php if(!empty($footer_details->footer_logo_img)){?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$footer_details->footer_logo_img.'')?>" width='80'>	
</div>
<?php }?>
<div class="form-group">
<label>Image Alt Text</label>
<?php
$data=['name'=>'footer_logo_img_alt','class'=>'form-control','placeholder'=>'Image Alt Text','value'=>$footer_details->footer_logo_img_alt];
...
<?php
$data=['name'=>'description','class'=>'form-control','placeholder'=>'Description','value'=>$footer_details->description];
...
<?php
$data=['name'=>'fb_link','class'=>'form-control','placeholder'=>'Facebook Link','value'=>$footer_details->fb_link];
echo form_input($data)?>
</div>
...
<?php
$data=['name'=>'twitter_link','class'=>'form-control','placeholder'=>'Twitter Link','value'=>$footer_details->twitter_link];
echo form_input($data)?>
</div>
...
<?php
$data=['name'=>'insta_link','class'=>'form-control','placeholder'=>'Instagram Link','value'=>$footer_details->insta_link];
echo form_input($data)?>
</div>
...
<?php
$data=['name'=>'copyright_text','class'=>'form-control','placeholder'=>'Copyright Text','value'=>$footer_details->copyright_text];
echo form_input($data)?>
</div>
...
<?php
$data=['disabled'=>'disabled','class'=>'form-control','placeholder'=>'Updated By','value'=>$footer_details->first_name.' '.$footer_details->last_name];
echo form_input($data)?>
</div>
...
<?php
$data=['disabled'=>'disabled','class'=>'form-control','placeholder'=>'Updated At','value'=>$footer_details->updated_at];
echo form_input($data)?>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($footer_details->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('footer_logo_img_hidden',$footer_details->footer_logo_img)?>
<button type="submit" name="update_about" class="btn btn-primary mr-2">Update</button>
