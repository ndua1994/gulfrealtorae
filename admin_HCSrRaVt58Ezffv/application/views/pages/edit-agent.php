...
<!--begin::Button-->
<a href="<?=base_url('agent/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('agent/update/'.$view_agent->agnt_id.'')?>
<div class="card-body">

<div class="form-group">
<label>Image
<span class="text-danger">*</span></label>
<?php echo form_upload(['name'=>'agnt_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$view_agent->agnt_img.'')?>" width="80">	
</div>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'agnt_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>$view_agent->agnt_img_alt];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'agnt_name','class'=>'form-control','placeholder'=>'Name','value'=>$view_agent->agnt_name];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Designation
</label>
<?php
$data=['name'=>'agnt_desg','class'=>'form-control','placeholder'=>'Designation','value'=>$view_agent->agnt_desg];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Office Number
</label>
<?php
$data=['name'=>'agnt_offc_number','class'=>'form-control','placeholder'=>'Office Number','value'=>$view_agent->agnt_offc_number];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_mob_number','class'=>'form-control','placeholder'=>'Mobile Number','value'=>$view_agent->agnt_mob_number];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">BRN
</label>
<?php
$data=['name'=>'agnt_brn','class'=>'form-control','placeholder'=>'BRN','value'=>$view_agent->agnt_brn];
echo form_input($data);
?>
</div>
...
<textarea name="agnt_description" class="form-control" id="kt-tinymce-4" 
placeholder=" Description"><?=$view_agent->agnt_description?></textarea>
</div>
...
<?php
$data=['name'=>'agnt_fb_link','class'=>'form-control','placeholder'=>'Facebook Link','value'=>$view_agent->agnt_fb_link];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_twitter_link','class'=>'form-control','placeholder'=>'Twitter Link','value'=>$view_agent->agnt_twitter_link];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Linkedin Link
</label>
<?php
$data=['name'=>'agnt_linkedin_link','class'=>'form-control','placeholder'=>'Linkedin Link','value'=>$view_agent->agnt_linkedin_link];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Pinterest Link
</label>
<?php
$data=['name'=>'agnt_pinterest_link','class'=>'form-control','placeholder'=>'Pinterest Link','value'=>$view_agent->agnt_pinterest_link];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_meta_title','class'=>'form-control','placeholder'=>'Meta Title','value'=>$view_agent->meta_title];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'agnt_meta_keyword','class'=>'form-control','placeholder'=>'Meta Keyword','value'=>$view_agent->meta_keyword];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'agnt_meta_description','class'=>'form-control','placeholder'=>'Meta Description','value'=>$view_agent->meta_description];
echo form_textarea($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Agent Slug
</label>
<?php
$data=['name'=>'agnt_slug','class'=>'form-control','placeholder'=>'Agent Slug','value'=>$view_agent->agnt_slug];
echo form_input($data);
?>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($view_agent->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('agnt_img_hidden',$view_agent->agnt_img);?>
<button type="submit" name="update_agent" class="btn btn-primary mr-2">Update</button>
...
<div class="navi-text">
<div class="font-weight-bold font-size-lg">Avarage 4 agnt posts per author</div>
