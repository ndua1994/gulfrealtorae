...
<h3 class="card-label">Add Blog</h3>
</div>
...
<?php
$data=['name'=>'blog_img_alt_tag','class'=>'form-control','placeholder'=>'Blog Image Alt Tag','value'=>set_value('blog_img_alt_tag')];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'blog_heading','class'=>'form-control','placeholder'=>'Blog Heading','value'=>set_value('blog_heading')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_short_description','class'=>'form-control','placeholder'=>'Blog Short Description','value'=>set_value('blog_short_description')];
...
<textarea id="kt-tinymce-4" name="blog_long_description" class="tox-target" placeholder="Blog Long Description"><?=set_value('blog_long_description')?></textarea>
</div>
...
<?php
$data=['name'=>'blog_author_img_alt','class'=>'form-control','placeholder'=>'Blog Author Image Alt Tag','value'=>set_value('blog_author_img_alt')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_author_name','class'=>'form-control','placeholder'=>'Blog Author Name','value'=>set_value('blog_author_name')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_author_descp','class'=>'form-control','placeholder'=>'Blog Author Description','value'=>set_value('blog_author_descp')];
echo form_textarea($data);
?>
</div>
<div class="form-group">
...
<input id="kt_tagify_1" class="form-control tagify" name='blog_tags' placeholder="Add Blog Tags" value="<?=set_value('blog_tags')?>" />
</div>
<div class="form-group">
<label for="exampleInputPassword1">Meta Title
</label>
<?php
$data=['name'=>'blog_meta_title','class'=>'form-control','placeholder'=>'Meta Title','value'=>set_value('blog_meta_title')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_meta_keyword','class'=>'form-control','placeholder'=>'Meta Keyword','value'=>set_value('blog_meta_keyword')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_meta_description','class'=>'form-control','placeholder'=>'Meta Description','value'=>set_value('blog_meta_description')];
echo form_textarea($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'blog_slug','class'=>'form-control','placeholder'=>'Blog Slug','value'=>set_value('blog_slug')];
echo form_input($data);
?>
</div>
