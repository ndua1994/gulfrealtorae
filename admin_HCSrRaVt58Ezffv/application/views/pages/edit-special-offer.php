...
<h3 class="card-label">Edit Special Offer</h3>
</div>
<div class="card-toolbar">
<!--begin::Button-->
<a href="<?=base_url('special-offer/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('special-offer/update/'.$edit_special_offer->id.'')?>
<div class="card-body">

<div class="form-group">
<label>Image
<span class="text-danger">*</span></label>
<?php echo form_upload(['name'=>'offer_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$edit_special_offer->offer_img.'')?>" width='80'>	
</div>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'offer_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>$edit_special_offer->offer_img_alt];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'heading','class'=>'form-control','placeholder'=>'Heading','value'=>$edit_special_offer->heading];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'project_url','class'=>'form-control','placeholder'=>'Project Url','value'=>$edit_special_offer->project_url];
echo form_input($data);
?>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($edit_special_offer->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<div class="card-footer">
	<?=form_hidden('special_offer_img_hidden',$edit_special_offer->offer_img)?>
<button type="submit" name="update_special_offer" class="btn btn-primary mr-2">Update</button>
