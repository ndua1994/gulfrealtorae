...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('user/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
        ...
        <tbody>
            ...
            <tr>
				...
				<td><span class="label label-lg font-weight-bold 
					<?=($user->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($user->is_active==1 ? 'Active' : 'Inactive')?></span></td>
                <td><a href="<?=base_url('user/edit/'.$user->login_id.'')?>" class="btn btn-warning">Edit</a></td>
                <td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('user/delete/'.$user->login_id.'')?>">Delete</a></td>
            </tr>
        <?php }?>
