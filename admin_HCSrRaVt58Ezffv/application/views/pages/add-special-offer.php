...
<h3 class="card-label">Add Special Offer</h3>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('special-offer/add')?>
<div class="card-body">
...
<?php
$data=['name'=>'offer_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>set_value('offer_img_alt')];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'heading','class'=>'form-control','placeholder'=>'Heading','value'=>set_value('heading')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'project_url','class'=>'form-control','placeholder'=>'Project Url','value'=>set_value('project_url')];
echo form_input($data);
?>
</div>
...
<button type="submit" name="add_special_offer" class="btn btn-primary mr-2">Add</button>
