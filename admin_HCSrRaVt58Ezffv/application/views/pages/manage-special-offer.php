...
<h3 class="card-label">Manage Special Offer</h3>
</div>
...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('special-offer/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
...
<table id="example" class="table  table-bordered" style="width:100%">
        ...
        <tbody>
		<?php foreach($special_offer as $key=>$special_offer){?>
		<tr>
		<td><?=++$key?></td>
		<td>
		<img src="<?=base_url('uploads/'.$special_offer->offer_img.'')?>" width='120'></td>
		<td><?=$special_offer->heading?></td>
		<td><?=$special_offer->first_name.' '.$special_offer->last_name?></td>
		<td><?=$special_offer->updated_at?></td>
		<td><span class="label label-lg font-weight-bold 
		<?=($special_offer->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($special_offer->is_active==1 ? 'Active' : 'Inactive')?></span></td>
		<td><a href="<?=base_url('special-offer/edit/'.$special_offer->id.'')?>" class="btn btn-warning">Edit</a></td>
		<td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('special-offer/delete/'.$special_offer->id.'')?>">Delete</a></td>
		</tr>
		<?php }?>  
        </tbody>
        <tfoot>
