...
<h3 class="card-label">Add Virtual Tour</h3>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('virtual-tour/add')?>
<div class="card-body">
...
<?php
$data=['name'=>'vt_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>set_value('vt_img_alt')];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'vt_heading','class'=>'form-control','placeholder'=>'Heading','value'=>set_value('vt_heading')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'vt_url','class'=>'form-control','placeholder'=>'URL','value'=>set_value('vt_url')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'vt_slug','class'=>'form-control','placeholder'=>'Slug','value'=>set_value('vt_slug')];
echo form_input($data);
?>
</div>
...
<button type="submit" name="add_virtual_tour" class="btn btn-primary mr-2">Add</button>
