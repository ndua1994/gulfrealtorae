...
<h3 class="card-label">Add Property</h3>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('property/add')?>
<div class="card-body">
...
<select class="form-control" name="comm_id">
	    ...
	    <option value="<?=$comm->comm_id?>" <?=set_value('comm_id')==$comm->comm_id ? 'selected' : ''?>><?=$comm->comm_heading?></option>
	    <?php endforeach;?>
</select>
...
<select class="form-control" name="prop_type_id">
	    ...
	    <option value="<?=$prop_type->prop_type_id?>" <?=set_value('prop_type_id')==$prop_type->prop_type_id ? 'selected' : ''?>><?=$prop_type->prop_type_name?></option>
	    <?php endforeach;?>
</select>	
</div>
...
<?php
$data=['name'=>'prop_img_alt','class'=>'form-control','placeholder'=>'Property Image Alt Tag','value'=>set_value('prop_img_alt')];
...
<?php
$data=['name'=>'prop_dev_img_alt','class'=>'form-control','placeholder'=>'Property Developer Image Alt Tag','value'=>set_value('prop_dev_img_alt')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'prop_name','class'=>'form-control','placeholder'=>'Property Name','value'=>set_value('prop_name')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'prop_price','class'=>'form-control','placeholder'=>'Property Price','value'=>set_value('prop_price')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'prop_beds','class'=>'form-control','placeholder'=>'Property Beds','value'=>set_value('prop_beds')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'prop_sqfeet','class'=>'form-control','placeholder'=>'Property Sq. Feet','value'=>set_value('prop_sqfeet')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'prop_addr','class'=>'form-control','placeholder'=>'Property Address','value'=>set_value('prop_addr')];
echo form_input($data);
?>
</div>
...
<textarea  name="prop_descp" class="tox-target kt-tinymce" placeholder="Property Description"><?=set_value('prop_descp')?></textarea>
</div>
...
<textarea  name="prop_details" class="tox-target kt-tinymce" placeholder="Property Details"><?=set_value('prop_details')?></textarea>
</div>
...
<textarea  name="prop_feature" class="tox-target kt-tinymce" placeholder="Property Feature"><?=set_value('prop_feature')?></textarea>
</div>
...
<?php
$data=['name'=>'prop_loc_descp','class'=>'form-control','placeholder'=>'Property Location Description','value'=>set_value('prop_loc_descp')];
...
<?php
$data=['name'=>'prop_loc_map','class'=>'form-control','placeholder'=>'Property Location Map','value'=>set_value('prop_loc_map')];
echo form_input($data);
?>
</div>
...
<label>
<input type="checkbox" name="is_featured" value="1" <?=(set_value('is_featured')==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<button type="submit" name="add_user" class="btn btn-primary mr-2">Add</button>
