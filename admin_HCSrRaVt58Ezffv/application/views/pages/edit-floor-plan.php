...
<h3 class="card-label">Edit Floor Plan</h3>
</div>
<div class="card-toolbar">
<!--begin::Button-->
<a href="<?=base_url().'property/floor-plan/'.$fp_details->prop_id.''?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('property/update-floor-plan/'.$fp_details->prop_id.'')?>
<div class="card-body">

<div class="form-group">
<label>Image
<span class="text-danger">*</span></label>
<input type="file" name="floor_imgs[]" class="form-control" multiple>
<div class="fp_mult_imgs mt-3">
<?php
$fp_imgs_arr=explode(',',$fp_details->floor_imgs);
foreach($fp_imgs_arr as $imgs):
?>	
<div class="fp_img_del" data-id="<?=$fp_details->prop_floorplan_id?>" data-img="<?=$imgs?>" ><span>X</span>
	<img src='<?=base_url()?>uploads/<?=$imgs?>' width='80' height='50'>
</div>
...
<?php
$data=['name'=>'floor_name','class'=>'form-control','placeholder'=>'Floor Name','value'=>$fp_details->floor_name];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Size
<span class="text-danger">*</span>
</label>
<?php
$data=['name'=>'floor_size','class'=>'form-control','placeholder'=>'Floor Size','value'=>$fp_details->floor_size];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Room
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'floor_room','class'=>'form-control','placeholder'=>'Floor Room','value'=>$fp_details->floor_room];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Bath
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'floor_bath','class'=>'form-control','placeholder'=>'Floor Bath','value'=>$fp_details->floor_bath];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Price
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'floor_price','class'=>'form-control','placeholder'=>'Floor Price','value'=>$fp_details->floor_price];
echo form_input($data);
?>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($fp_details->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<div class="card-footer">
	<input type="hidden" name="prop_floorplan_id" value="<?=$fp_details->prop_floorplan_id?>">
	<input type="hidden" name="prop_id" value="<?=$fp_details->prop_id?>">
	<input type="hidden" name="prop_inner_img_hidden" value="<?=$fp_details->floor_imgs?>">
<button type="submit" name="update_floor_plan" class="btn btn-primary mr-2">Update</button>
