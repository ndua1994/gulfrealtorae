...
<!--begin::Button-->
<a href="<?=base_url('user/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open('user/update/'.$view_user->login_id.'')?>
<div class="card-body">
<div class="form-group">
<label>First Name
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'first_name','class'=>'form-control','placeholder'=>'First Name','value'=>$view_user->first_name];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'last_name','class'=>'form-control','placeholder'=>'Last Name','value'=>$view_user->last_name];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'email','class'=>'form-control','placeholder'=>'Enter Email ID','value'=>$view_user->email,'disabled'=>'disabled'];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'password','class'=>'form-control','placeholder'=>'Enter Password','value'=>$view_user->password,'disabled'=>'disabled'];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'confirm_password','class'=>'form-control','placeholder'=>'Enter Confirm Password','value'=>$view_user->password,'disabled'=>'disabled'];
echo form_password($data);
?>
</div>
<div class="form-group">
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($view_user->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('edit_id',$view_user->login_id)?>
<button type="submit" name="add_user" class="btn btn-primary mr-2">Update</button>
