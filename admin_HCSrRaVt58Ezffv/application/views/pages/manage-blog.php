...
<h3 class="card-label">Manage Blog</h3>
</div>
...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('blog/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
...
<table id="example" class="table  table-bordered" style="width:100%">
		...
		<td><?=++$key?></td>
		<td>
		<img src="<?=base_url('uploads/'.$blog->blog_img.'')?>" width='120'></td>
		<td><?=$blog->blog_heading?></td>
		<td><?=$blog->first_name.' '.$blog->last_name?></td>
		<td><?=$blog->updated_at?></td>
		<td><span class="label label-lg font-weight-bold 
		<?=($blog->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($blog->is_active==1 ? 'Active' : 'Inactive')?></span></td>
		<td><a href="<?=base_url('blog/edit/'.$blog->blog_id.'')?>" class="btn btn-warning">Edit</a></td>
		<td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('blog/delete/'.$blog->blog_id.'')?>">Delete</a></td>
		</tr>
		<?php }?>  
        </tbody>
        <tfoot>
