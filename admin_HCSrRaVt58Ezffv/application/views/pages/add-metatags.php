...
<h3 class="card-label">Add Meta Tag</h3>
</div>
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'meta_slug','class'=>'form-control','placeholder'=>'Meta Slug','value'=>set_value('meta_slug')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<button type="submit" name="add_metatag" class="btn btn-primary mr-2">Add</button>
