...
<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?=$this->session->userdata('login_username')?></span>
<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
<span class="symbol-label font-size-h5 font-weight-bold"><?=substr($this->session->userdata('login_username'),0,1)?></span>
</span>
</div>
</div>
<!--end::User-->
...
<!--begin::Button-->
<a href="<?=base_url('property/manage')?>" class="btn btn-primary font-weight-bolder">
...
<?php }else if(!empty($upload_error)){?>
<div class="alert alert-custom alert-notice alert-light-danger fade show mb-5" role="alert">
<div class="alert-text"><?=$upload_error?></div>
<div class="alert-close">
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
</button>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('property/update/'.$prop_details->prop_id.'')?>
<div class="card-body">
...
<select class="form-control" name="comm_id">
	    ...
	    <?php foreach($view_comm as $comm):?>
	    <option value="<?=$comm->comm_id?>" <?=$prop_details->comm_id==$comm->comm_id ? 'selected' : ''?>><?=$comm->comm_heading?></option>
	    <?php endforeach;?>
</select>
...
<div class="form-group">
		<label>Property Type
<span class="text-danger">*</span></label>
<select class="form-control" name="prop_type_id">
	    <option value="">Select Property Type</option>
	    <?php foreach($view_prop_type as $prop_type):?>
	    <option value="<?=$prop_type->prop_type_id?>" <?=$prop_details->prop_type_id==$prop_type->prop_type_id ? 'selected' : ''?>><?=$prop_type->prop_type_name?></option>
	    <?php endforeach;?>
</select>	
</div>
...
<?php echo form_upload(['name'=>'prop_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$prop_details->prop_img.'')?>" width='80'>	
</div>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Image Alt Tag
</label>
<?php
$data=['name'=>'prop_img_alt','class'=>'form-control','placeholder'=>'Property Image Alt Tag','value'=>$prop_details->prop_img_alt];
echo form_input($data);
?>
</div>

<div class="form-group">
<label>Property Inner Images</label>
<input type="file" name="prop_inner_img[]" class="form-control" multiple>
<div class="mt-2 prop_inner_list">
<?php

 if(!empty($prop_inner_images[0])):
 foreach($prop_inner_images as $prop_inner_img):?>	
<div class="inner_img_del" data-id="<?=$prop_details->prop_id?>" data-img=<?=$prop_inner_img?> ><span>X</span>
<img src="<?=base_url('uploads/'.$prop_inner_img.'')?>" width='80'>	
</div>
<?php endforeach;
endif;?>
</div>
...
<?php echo form_upload(['name'=>'prop_dev_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$prop_details->prop_dev_img.'')?>" width='80'>	
</div>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Developer Image Alt Tag
</label>
<?php
$data=['name'=>'prop_dev_img_alt','class'=>'form-control','placeholder'=>'Property Developer Image Alt Tag','value'=>$prop_details->prop_dev_img_alt];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Property Name
</label>
<?php
$data=['name'=>'prop_name','class'=>'form-control','placeholder'=>'Property Name','value'=>$prop_details->prop_name];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Price
</label>
<?php
$data=['name'=>'prop_price','class'=>'form-control','placeholder'=>'Property Price','value'=>$prop_details->prop_price];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Beds
</label>
<?php
$data=['name'=>'prop_beds','class'=>'form-control','placeholder'=>'Property Beds','value'=>$prop_details->prop_beds];
echo form_input($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Sqfeet
</label>
<?php
$data=['name'=>'prop_sqfeet','class'=>'form-control','placeholder'=>'Property Sq. Feet','value'=>$prop_details->prop_sqfeet];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Property Address
</label>
<?php
$data=['name'=>'prop_addr','class'=>'form-control','placeholder'=>'Property Address','value'=>$prop_details->prop_addr];
echo form_input($data);
?>
</div>
...
<?php echo form_upload(['name'=>'prop_brochure','class'=>'form-control']);?>
<div class="mt-2">
<a class="btn btn-primary" href="<?=base_url('uploads/'.$prop_details->prop_brochure.'')?>" target="_blank">View PDF</a>	
</div>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Description
</label>
<textarea  name="prop_descp" class="tox-target kt-tinymce" placeholder="Property Description"><?=$prop_details->prop_descp?></textarea>
</div>


<div class="form-group">
<label for="exampleInputPassword1">Property Details
</label>
<textarea  name="prop_details" class="tox-target kt-tinymce" placeholder="Property Details"><?=$prop_details->prop_details?></textarea>
</div>


<div class="form-group">
<label for="exampleInputPassword1">Property Feature
</label>
<textarea  name="prop_feature" class="tox-target kt-tinymce" placeholder="Property Feature"><?=$prop_details->prop_feature?></textarea>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Location Description
</label>
<?php
$data=['name'=>'prop_loc_descp','class'=>'form-control','placeholder'=>'Property Location Description','value'=>$prop_details->prop_loc_descp];
echo form_textarea($data);
?>
</div>

<div class="form-group">
<label for="exampleInputPassword1">Property Location Map
</label>
<?php
$data=['name'=>'prop_loc_map','class'=>'form-control','placeholder'=>'Property Location Map','value'=>$prop_details->prop_loc_map];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'prop_slug','class'=>'form-control','placeholder'=>'Property Slug','value'=>$prop_details->prop_slug];
echo form_input($data);
?>
</div>
...
<div class="form-group">
<label for="exampleInputPassword1">Featured Property</label>
<span class="switch switch-md switch-icon">
<label>
<input type="checkbox" name="is_featured" value="1" <?=($prop_details->is_featured==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<span class="switch switch-md switch-icon">
<label>
<input type="checkbox" name="is_active" value="1" <?=($prop_details->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('prop_img_hidden',$prop_details->prop_img)?>
<?=form_hidden('prop_inner_img_hidden',$prop_details->prop_inner_img)?>	
<?=form_hidden('prop_brochure_hidden',$prop_details->prop_brochure)?>
<?=form_hidden('prop_dev_img_hidden',$prop_details->prop_dev_img)?>	
...
<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?=$this->session->userdata('login_username')?></a>
<div class="text-muted mt-1"><?=$this->session->userdata('login_type')?></div>
<div class="navi mt-2">
...
<span class="navi-text text-muted text-hover-primary"><?=$this->session->userdata('login_email')?></span>
</span>
</a>
