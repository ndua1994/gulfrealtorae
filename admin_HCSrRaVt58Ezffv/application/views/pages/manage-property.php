...
<h3 class="card-label">Manage Property</h3>
</div>
...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('property/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
...
<table id="example" class="table  table-bordered" style="width:100%">
        ...
        <tbody>
		<?php foreach($view_prop as $key=>$prop){?>
		<tr>
		<td><?=++$key?></td>
		<td>
		...
		<?=($prop->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($prop->is_active==1 ? 'Active' : 'Inactive')?></span></td>
		<td><a href="<?=base_url('property/edit/'.$prop->prop_id.'')?>" class="btn btn-warning">Edit</a></td>
		<td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('property/delete/'.$prop->prop_id.'')?>">Delete</a></td>
		</tr>
		<?php }?>  
        </tbody>
        <tfoot>
