...
<h3 class="card-label">Edit Meta Tag</h3>
</div>
<div class="card-toolbar">
<!--begin::Button-->
<a href="<?=base_url('meta-tag/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open('meta-tag/update/'.$view_meta->id.'')?>
<div class="card-body">
<div class="form-group">
<label>Meta Title
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'meta_title','class'=>'form-control','placeholder'=>'Meta Title','value'=>$view_meta->meta_title];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'meta_keyword','class'=>'form-control','placeholder'=>'Meta Keyword','value'=>$view_meta->meta_keyword];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'meta_description','class'=>'form-control','placeholder'=>'Meta Description','value'=>$view_meta->meta_description];
echo form_textarea($data);
?>
</div>
<div class="form-group">
<label for="exampleInputPassword1">Meta Slug
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'meta_slug','class'=>'form-control','placeholder'=>'Meta Slug','value'=>$view_meta->meta_slug];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($view_meta->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('edit_id',$view_meta->id)?>
<button type="submit" name="update_metatag" class="btn btn-primary mr-2">Update</button>
