...
<!--begin::Button-->
<a href="<?=base_url('upload-image/manage')?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('upload-image/update/'.$view_image->upload_id.'')?>
<div class="card-body">

<div class="form-group">
<label>Image
<span class="text-danger">*</span></label>
<?php echo form_upload(['name'=>'upload_img','class'=>'form-control']);?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$view_image->upload_img.'')?>" width="80">	
</div>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($view_image->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('upload_img_hidden',$view_image->upload_img);?>
