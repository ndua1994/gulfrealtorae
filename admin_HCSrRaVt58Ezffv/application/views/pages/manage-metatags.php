...
<h3 class="card-label">Manage Meta Tag</h3>
</div>
...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('meta-tag/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
...
<table id="example" class="table  table-bordered" style="width:100%">
        ...
        <tbody>
        	...
        	<?php foreach($meta_all as $key=>$tags){?>
            <tr>
                <td><?=++$key?></td>
                <td><?=$tags->meta_title?></td>
                <td><?=$tags->meta_keyword?></td>
                <td><?=$tags->meta_description?></td>
                <td><?=$tags->meta_slug?></td>
                <td><?=$tags->first_name.' '.$tags->last_name?></td>
                <td><?=$tags->updated_at?></td>
				<td><span class="label label-lg font-weight-bold 
					<?=($tags->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($tags->is_active==1 ? 'Active' : 'Inactive')?></span></td>
                <td><a href="<?=base_url('meta-tag/edit/'.$tags->id.'')?>" class="btn btn-warning">Edit</a></td>
                <td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('meta-tag/delete/'.$tags->id.'')?>">Delete</a></td>
            </tr>
        <?php }?>
