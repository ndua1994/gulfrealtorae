...
<h3 class="card-label">Manage Agent</h3>
</div>
...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('agent/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
...
<table id="example" class="table  table-bordered" style="width:100%">
        ...
        <tbody>
		<?php foreach($agent as $key=>$agnt){?>
		<tr>
		<td><?=++$key?></td>
		<td>
		<img src="<?=base_url('uploads/'.$agnt->agnt_img.'')?>" width='120'></td>
		<td><?=$agnt->agnt_name?></td>
		<td><?=$agnt->agnt_desg?></td>
		<td><?=$agnt->first_name.' '.$agnt->last_name?></td>
		<td><?=$agnt->updated_at?></td>
		<td><span class="label label-lg font-weight-bold 
		<?=($agnt->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($agnt->is_active==1 ? 'Active' : 'Inactive')?></span></td>
		<td><a href="<?=base_url('agent/edit/'.$agnt->agnt_id.'')?>" class="btn btn-warning">Edit</a></td>
		<td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('agent/delete/'.$agnt->agnt_id.'')?>">Delete</a></td>
		</tr>
		<?php }?>  
        </tbody>
        <tfoot>
