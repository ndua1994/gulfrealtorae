...
<!--begin::Form-->
<?=form_open('pages/contact_update')?>
<div class="card-body">
<div class="form-group">
<label>Heading
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'contct_heading','class'=>'form-control','placeholder'=>'Heading','value'=>$rec->contct_heading];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'contct_short_descp','class'=>'form-control','placeholder'=>'Short Description','value'=>$rec->contct_short_descp];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'contct_number','class'=>'form-control','placeholder'=>'Phone Number','value'=>$rec->contct_number];
echo form_input($data)?>
</div>
<div class="form-group">
<label>Website
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'contct_website','class'=>'form-control','placeholder'=>'Website','value'=>$rec->contct_website];
echo form_input($data)?>
</div>
<div class="form-group">
<label>Email ID
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'contct_email','class'=>'form-control','placeholder'=>'Email ID','value'=>$rec->contct_email];
echo form_input($data)?>
</div>
<div class="form-group">
<label>Google Map
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'contct_gmap','class'=>'form-control','placeholder'=>'Google Map','value'=>$rec->contct_gmap];
echo form_textarea($data)?>
</div>
...
<button type="submit" name="update_contact" class="btn btn-primary mr-2">Update</button>
