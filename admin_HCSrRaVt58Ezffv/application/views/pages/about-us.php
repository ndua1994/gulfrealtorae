...
<!--begin::Form-->
<?=form_open_multipart('pages/about_update')?>
<div class="card-body">
<div class="form-group">
<label>Image 
<span class="text-danger">*</span></label>
<input type="file" name="abt_img" class="form-control">
</div>
<?php if(!empty($rec->abt_img)){?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$rec->abt_img.'')?>" width='80'>	
</div>
<?php }?>
<div class="form-group">
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'abt_img_alt','class'=>'form-control','placeholder'=>'Image Alt Text','value'=>$rec->abt_img_alt];
...
<span class="text-danger">*</span></label>
<textarea id="kt-tinymce-4" name="abt_description" class="tox-target" placeholder="About Description"><?=$rec->abt_description?></textarea>
</div>
...
<?=form_hidden('abt_img_hidden',$rec->abt_img)?>
