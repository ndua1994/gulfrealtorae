...
<!--begin::Form-->
<?=form_open_multipart('upload-image/add')?>
<div class="card-body">
...
<?php if(!empty($rec->upload_img)){?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$rec->upload_img.'')?>" width='80'>	
</div>
<?php }?>
...
<button type="submit" name="update_image" class="btn btn-primary mr-2">Upload Image</button>
</div>
<?=form_close()?>
<!--end::Form-->
</div>
