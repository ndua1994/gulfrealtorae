...
<h3 class="card-label">Edit Community</h3>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('community/update/'.$view_comm->comm_id.'')?>
<div class="card-body">
...
<div class="mt-2">
<img src="<?=base_url('uploads/'.$view_comm->comm_img.'')?>" width='80'>	
</div>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'comm_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>$view_comm->comm_img_alt];
...
<div class="mt-2">
<img src="<?=base_url('uploads/'.$view_comm->comm_inner_img.'')?>" width='80'>	
</div>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'comm_inner_img_alt','class'=>'form-control','placeholder'=>'Inner Image Alt Tag','value'=>$view_comm->comm_inner_img_alt];
echo form_input($data);
?>
</div>
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'comm_heading','class'=>'form-control','placeholder'=>'Heading','value'=>$view_comm->comm_heading];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'comm_loc','class'=>'form-control','placeholder'=>'Location','value'=>$view_comm->comm_loc];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'comm_short_descp','class'=>'form-control','placeholder'=>'Short Description','value'=>$view_comm->comm_short_descp];
...
placeholder="Long Description"><?=$view_comm->comm_long_descp?></textarea>
</div>
...
<?php
$data=['name'=>'comm_map','class'=>'form-control','placeholder'=>'Map','value'=>$view_comm->comm_map];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'meta_title','class'=>'form-control','placeholder'=>'Meta Title','value'=>$view_comm->meta_title];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'meta_keyword','class'=>'form-control','placeholder'=>'Meta Keyword','value'=>$view_comm->meta_keyword];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'meta_description','class'=>'form-control','placeholder'=>'Meta Description','value'=>$view_comm->meta_description];
echo form_textarea($data);
?>
</div>
...
<?php
$data=['name'=>'comm_slug','class'=>'form-control','placeholder'=>'Slug','value'=>$view_comm->comm_slug];
echo form_input($data);
?>
</div>
...
<label>
<input type="checkbox" name="is_active" value="1" <?=($view_comm->is_active==1 ? 'checked' : '')?>>
<span></span>
</label>
</span>
</div>
...
<?=form_hidden('comm_img_hidden',$view_comm->comm_img)?>
<?=form_hidden('comm_inner_img_hidden',$view_comm->comm_inner_img)?>	
<button type="submit" name="edit_community" class="btn btn-primary mr-2">Update</button>
