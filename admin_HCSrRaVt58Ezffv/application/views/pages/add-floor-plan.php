...
<h3 class="card-label">Add Floor Plan</h3>
</div>
<div class="card-toolbar">
<!--begin::Button-->
<a href="<?=base_url().'property/floor-plan/'.$prop_id.''?>" class="btn btn-primary font-weight-bolder">
...
<!--begin::Form-->
<?=form_open_multipart('property/add-floor-plan/'.$prop_id.'')?>
<div class="card-body">
...
<?php
$data=['name'=>'floor_name','class'=>'form-control','placeholder'=>'Floor Name','value'=>set_value('floor_name')];
...
<?php
$data=['name'=>'floor_size','class'=>'form-control','placeholder'=>'Floor Size','value'=>set_value('floor_size')];
echo form_input($data);
?>
</div>
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'floor_room','class'=>'form-control','placeholder'=>'Floor Room','value'=>set_value('floor_room')];
echo form_input($data);
?>
</div>
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'floor_bath','class'=>'form-control','placeholder'=>'Floor Bath','value'=>set_value('floor_bath')];
echo form_input($data);
?>
</div>
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'floor_price','class'=>'form-control','placeholder'=>'Floor Price','value'=>set_value('floor_price')];
echo form_input($data);
?>
</div>
...
<button type="submit" name="add_floor_plan" class="btn btn-primary mr-2">Add</button>
