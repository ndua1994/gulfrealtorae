...
<?php
$data=['name'=>'agnt_img_alt','class'=>'form-control','placeholder'=>'Image Alt Tag','value'=>set_value('agnt_img_alt')];
...
<span class="text-danger">*</span></label>
<?php
$data=['name'=>'agnt_name','class'=>'form-control','placeholder'=>'Name','value'=>set_value('agnt_name')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_desg','class'=>'form-control','placeholder'=>'Designation','value'=>set_value('agnt_desg')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_offc_number','class'=>'form-control','placeholder'=>'Office Number','value'=>set_value('agnt_offc_number')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_mob_number','class'=>'form-control','placeholder'=>'Mobile Number','value'=>set_value('agnt_mob_number')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_brn','class'=>'form-control','placeholder'=>'BRN','value'=>set_value('agnt_brn')];
echo form_input($data);
?>
</div>
...
placeholder=" Description"><?=set_value('agnt_description')?></textarea>
</div>
...
<?php
$data=['name'=>'agnt_fb_link','class'=>'form-control','placeholder'=>'Facebook Link','value'=>set_value('agnt_fb_link')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_twitter_link','class'=>'form-control','placeholder'=>'Twitter Link','value'=>set_value('agnt_twitter_link')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_linkedin_link','class'=>'form-control','placeholder'=>'Linkedin Link','value'=>set_value('agnt_linkedin_link')];
echo form_input($data);
?>
</div>
...
<?php
$data=['name'=>'agnt_pinterest_link','class'=>'form-control','placeholder'=>'Pinterest Link','value'=>set_value('agnt_pinterest_link')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'agnt_meta_title','class'=>'form-control','placeholder'=>'Meta Title','value'=>set_value('agnt_meta_title')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'agnt_meta_keyword','class'=>'form-control','placeholder'=>'Meta Keyword','value'=>set_value('agnt_meta_keyword')];
echo form_input($data);
?>
</div>
<div class="form-group">
...
<?php
$data=['name'=>'agnt_meta_description','class'=>'form-control','placeholder'=>'Meta Description','value'=>set_value('agnt_meta_description')];
...
<?php
$data=['name'=>'agnt_slug','class'=>'form-control','placeholder'=>'Agent Slug','value'=>set_value('agnt_slug')];
echo form_input($data);
?>
</div>
...
<button type="submit" name="add_agent" class="btn btn-primary mr-2">Add</button>
