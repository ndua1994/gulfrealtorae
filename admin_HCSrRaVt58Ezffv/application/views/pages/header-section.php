...
<h3 class="card-label">Header Section</h3>
</div>
...
<!--begin::Form-->
<?=form_open_multipart('pages/header_update')?>
<div class="card-body">
...
<?php if(!empty($rec->logo_img)){?>
<div class="mt-2">
<img src="<?=base_url('uploads/'.$rec->logo_img.'')?>" width='80'>	
</div>
<?php }?>
<div class="form-group">
<label>Image Alt Text</label>
<?php
$data=['name'=>'logo_img_alt','class'=>'form-control','placeholder'=>'Image Alt Text','value'=>$rec->logo_img_alt];
...
<?php
$data=['name'=>'mobile_no','class'=>'form-control','placeholder'=>'Mobile Number','value'=>$rec->mobile_no];
echo form_input($data)?>
</div>
...
<?php
$data=['name'=>'whatsapp_no','class'=>'form-control','placeholder'=>'Whatsapp Number','value'=>$rec->whatsapp_no];
echo form_input($data)?>
</div>
...
<?=form_hidden('logo_img_hidden',$rec->logo_img)?>
