...
<h3 class="card-label">Manage Virtual Tour</h3>
</div>
...
<!--end::Dropdown-->
<!--begin::Button-->
<a href="<?=base_url('virtual-tour/add')?>" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
...
<table id="example" class="table  table-bordered" style="width:100%">
        ...
        <tbody>
		<?php foreach($virtual_tour as $key=>$vt){?>
		<tr>
		<td><?=++$key?></td>
		<td>
		<img src="<?=base_url('uploads/'.$vt->vt_img.'')?>" width='120'></td>
		<td><?=$vt->vt_heading?></td>
		<td><?=$vt->vt_url?></td>
		<td><?=$vt->first_name.' '.$vt->last_name?></td>
		<td><?=$vt->updated_at?></td>
		<td><span class="label label-lg font-weight-bold 
		<?=($vt->is_active==1 ? 'label-light-success' : 'label-light-danger')?> label-inline"><?=($vt->is_active==1 ? 'Active' : 'Inactive')?></span></td>
		<td><a href="<?=base_url('virtual-tour/edit/'.$vt->vt_id.'')?>" class="btn btn-warning">Edit</a></td>
		<td><a href="javascript:void(0)" class="btn btn-danger del_rec" data-url="<?=base_url('virtual-tour/delete/'.$vt->vt_id.'')?>">Delete</a></td>
		</tr>
		<?php }?>  
        </tbody>
        <tfoot>
