	<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #3599fe;">
					<!--begin::Aside Top-->
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #fff;">Discover Amazing Metronic
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin">
							<!--begin::Form-->
							<form class="form" action="" method="post" novalidate="novalidate" id="login-frm">
								<!--begin::Title-->
								<div class="pb-5 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Gulf Realtor</h3>
								</div>

<div class="alert alert-custom alert-light-danger fade show mb-5 login_alert" role="alert" style="display:none;">
...
<span aria-hidden="true"><i class="ki ki-close"></i></span>
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="email" autocomplete="off" placeholder="Email ID" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										...
										<a href="<?=base_url('forgot-password')?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Forgot Password ?</a>
									</div>
								...
								<div class="pb-lg-0 pb-5">
									<button type="submit" name="login_submit" id="kt_login_signin_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Sign In</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
					...
					<div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
						<div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
							...
							<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Gulf Realtor</a>
						</div>
